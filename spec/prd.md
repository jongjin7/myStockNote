...
#### 5.3.1 보유 종목 (Holdings)

**기능 정의:** 현재 실제로 자산을 투입하여 보유하고 있는 종목을 관리한다.
...
#### 5.3.2 관심 종목 (Watchlist / 정찰 종목)
**기능 정의:** 아직 매수하지 않았지만, 리서치 자료를 축적하거나 매수 타이밍을 노리는 종목을 관리한다.
...
* 수량과 평균단가는 0 또는 null 처리
* 계좌에 속하지 않음 (accountId: null 허용)
* 매수 시 '보유 종목'으로 전환 가능 (수량, 단가, 계좌 입력 필요)
