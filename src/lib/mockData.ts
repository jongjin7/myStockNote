...
// 한국 주식 종목 샘플
const KOREAN_STOCKS = [
  { symbol: '005930', name: '삼성전자', category: 'Tech' },
  { symbol: '000660', name: 'SK하이닉스', category: 'Tech' },
  { symbol: '035420', name: 'NAVER', category: 'Communication' },
  { symbol: '005380', name: '현대차', category: 'Industrial' },
  { symbol: '051910', name: 'LG화학', category: 'BasicMaterials' },
  { symbol: '006400', name: '삼성SDI', category: 'Energy' },
  { symbol: '035720', name: '카카오', category: 'Communication' },
  { symbol: '068270', name: '셀트리온', category: 'Healthcare' },
  { symbol: '207940', name: '삼성바이오로직스', category: 'Healthcare' },
  { symbol: '105560', name: 'KB금융', category: 'Finance' },
  { symbol: '055550', name: '신한지주', category: 'Finance' },
  { symbol: '000270', name: '기아', category: 'Industrial' },
  { symbol: '012330', name: '현대모비스', category: 'Industrial' },
  { symbol: '028260', name: '삼성물산', category: 'Industrial' },
  { symbol: '066570', name: 'LG전자', category: 'Tech' },
  { symbol: '003550', name: 'LG', category: 'Industrial' },
  { symbol: '017670', name: 'SK텔레콤', category: 'Communication' },
  { symbol: '034730', name: 'SK', category: 'Industrial' },
  { symbol: '096770', name: 'SK이노베이션', category: 'Energy' },
  { symbol: '009150', name: '삼성전기', category: 'Tech' },
];
