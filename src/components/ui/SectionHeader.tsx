      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          {count !== undefined && (
            <Badge 
              variant="default" 
              className="bg-primary-500/10 text-primary-400 border border-primary-500/10 text-[10px] font-black px-2.5 py-0 h-6 flex items-center gap-1.5 shadow-lg shadow-primary-500/5 transition-all group-hover:bg-primary-500/20"
            >
