        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-950 p-10 rounded-[32px] border border-gray-800/50 shadow-2xl relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mt-12 pt-10 border-t border-gray-800/40">
              <div className="space-y-2">
                <span className="text-gray-500 uppercase tracking-widest">평가자산</span>
                <div className="flex items-baseline font-black tracking-tight tabular-nums mt-1">
                  <span className="text-xs font-light text-gray-600 mr-2 opacity-50">₩</span>
                  <p className="text-2xl text-gray-100 font-num">{formatNumber(totalEvaluation)}</p>
                </div>
              </div>
              <div className="space-y-2">
                <span className="text-gray-500 uppercase tracking-widest">총 예수금</span>
                <div className="flex items-baseline font-black tracking-tight tabular-nums mt-1">
                  <span className="text-xs font-light text-gray-600 mr-2 opacity-50">₩</span>
              ...
              <div className="space-y-2">
                <span className="text-gray-500 uppercase tracking-widest">투자원금</span>
                <div className="flex items-baseline font-black tracking-tight tabular-nums mt-1">
                  <span className="text-xs font-light text-gray-600 mr-2 opacity-50">₩</span>
              ...
              <div className="space-y-2">
                <span className="text-gray-500 uppercase tracking-widest">현금 비중</span>
                <p className="text-2xl font-black text-primary-400 tracking-tight tabular-nums font-num mt-1">{cashRatio.toFixed(1)}%</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card interactive className="p-8 border-gray-800/50 bg-gray-900/30 hover:bg-gray-900/50 group overflow-hidden relative">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-lg text-gray-500 uppercase tracking-[0.2em]">Holdings | 운용 종목</span>
            </div>
            <div>
              <div className="text-5xl font-black text-white mb-2 tracking-tighter tabular-nums font-num">
                {holdingStocks.length} <span className="text-lg font-bold text-gray-500 uppercase ml-1 tracking-tight font-sans">개 종목</span>
              </div>
        ...
        <Card interactive className="p-8 border-gray-800/50 bg-gray-900/30 hover:bg-gray-900/50 group overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <div>
              <div className="text-5xl font-black text-white mb-2 tracking-tighter tabular-nums font-num">
                {memos.length} <span className="text-lg font-bold text-gray-500 uppercase ml-1 tracking-tight font-sans">개 메모</span>
              </div>
