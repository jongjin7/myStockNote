  ...
  {filteredStocks.length > 0 ? (
   ...
   return (
    ...
    <Card interactive className="p-8 border-gray-800 bg-gray-900/40 backdrop-blur-sm group hover:border-info/50 shadow-lg">
     ...
     <div className="text-sm text-gray-500 bg-gray-950/50 px-2 py-1 rounded inline-block border border-gray-800/50 uppercase tracking-widest">{stock.symbol || 'NO CODE'}</div>
     </div>
